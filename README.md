...
A end-to-end product analytics platform simulating the data science workflow at a B2C SaaS company — from raw event data to executive dashboards to ML-driven churn prediction.
...
- Monthly signups + cumulative user growth
...
- Monthly retention cohort heatmap (Day 0 to Month 6)
- Time-to-convert distribution by plan

### 🧪 A/B Testing Framework
- Experiment selector with 3 simulated experiments
- Statistical significance testing (z-test + Welch's t-test)
